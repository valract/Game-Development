...
missile_sound = pygame.mixer.Sound('resources/missile.wav')
enemy_sound = pygame.mixer.Sound('resources/enemy.wav')
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.lasers = [
            pygame.image.load("resources/laser1.png").convert_alpha(),
            pygame.image.load("resources/laser2.png").convert_alpha(),
            pygame.image.load("resources/laser3.png").convert_alpha(),
            pygame.image.load("resources/laser4.png").convert_alpha(),
        ]
        self.surf = pygame.image.load("resources/player3.png").convert_alpha()
...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.id = "ENEMY"
        self.surf = pygame.image.load("resources/astriod.png").convert_alpha()
        self.surf.set_colorkey((255, 255, 255), RLEACCEL)
        self.rect = self.surf.get_rect(
            center=(
...
image = pygame.image.load("resources/laser1.png").convert_alpha()
...
while run:
    ...
    for events in pygame.event.get():
        if events.type == QUIT:
            ...
            if ids >= 48:
                new_enemy.surf = pygame.image.load("resources/Health.png").convert_alpha()
                new_enemy.id = "HEALTH"
